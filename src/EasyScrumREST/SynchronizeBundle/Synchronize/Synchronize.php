...
class Synchronize
{
    ...
    public function synchronize($mobileDB, ApiUser $user)
    {
        ...
        return array('users'=>$this->em->getRepository('UserBundle:ApiUser')->findCompanyUsers($user->getCompany()->getId()),
                 'projects'=>ArrayHelper::flattMultilevelEntityArray($projects), 'backlog'=>ArrayHelper::flattMultilevelEntityArray($backlog),
                 'sprints'=>ArrayHelper::flattMultilevelEntityArray($sprints), 'tasks'=>ArrayHelper::flattMultilevelEntityArray($tasks));
    }
