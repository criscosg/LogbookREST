<?php
namespace EasyScrumREST\OwnerBundle\Test\Controller;
...
class OwnerControllerTest extends CustomTestCase
{
    ...
    {
        $param = array('owner' => array('name' => 'test', 'last_name' => 'test', 'email' => 'tester@tester.com', 'address' => 'Dortmund', 'company' => 1));
