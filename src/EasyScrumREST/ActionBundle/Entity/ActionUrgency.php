...
class ActionUrgency extends Action
{
    ...
    protected $titles = array(self::CREATE_URGENCY => "A new urgency has been created", self::DROPED_URGENCY => "A urgency has dropped from a sprint",
    ...
    protected $description = array(self::CREATE_URGENCY=>"The urgency %u% has been created",
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EasyScrumREST\TaskBundle\Entity\Urgency", inversedBy="actions")
     */
    private $urgency;
