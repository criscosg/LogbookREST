<?php
namespace EasyScrumREST\ImageBundle\Controller;
...
class ImageController extends FOSRestController
{
     ...
     * @QueryParam(name="task", requirements="\d+", nullable=true, description="The task.")
     *
     * @View()
     *
    ...
    public function getImagesAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('image.handler')->all($limit, $offset, null, $task);
    }
    ...
    public function getThumbnailsAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        return $this->container->get('image.thumbnail.handler')->all($limit, $offset, null, $task);
    }
