 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EasyScrumREST\ImageBundle\Entity\ImageCopyRepository")
 * @ORM\HasLifecycleCallbacks
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="subclase", type="string")
 * @ORM\DiscriminatorMap({"imagenavigation"="ImageNav", "imagethumbnail"="ImageThumbnail"})
 */
abstract class ImageCopy
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Image", inversedBy="imageCopies")
     */
    protected $image;
    ...
    public function uploadCopy($maximize=false)
    {
        ...
        $thumb = FileHelper::resizeAndSaveImage($image, $this->maxWidth, $this->maxHeight, $filePath, $this->sufix);
