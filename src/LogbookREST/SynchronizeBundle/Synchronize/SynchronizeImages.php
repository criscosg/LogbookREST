...
class SynchronizeImages
{
    ...
    private function compareImages($images, Veterinary $veterinary)
    {
        ...
        return $this->em->getRepository('ImageBundle:ImageEntry')->findNotInEntities($entities, $veterinary->getClinic()->getId());
    }
    
    private function saveImage($imageMobile,ImageEntry $imageDB)
    {
