<?php
namespace LogbookREST\ImageBundle\Tests\Entity;

use Doctrine\Common\Collections\ArrayCollection as Collection;
use LogbookREST\ImageBundle\Entity\ImageThumbnail;
...
class ImageTest extends CustomTestCase
{
    ...
    {
        $horse = $this->entityManager->getRepository('EntryBundle:Horse')->findOneById(1);
